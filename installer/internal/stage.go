...
type OrchInstallerStage interface {
	...
	PreStage(ctx context.Context, config OrchInstallerConfig, prevStageOutput RuntimeState) (RuntimeState, *OrchInstallerError)

	// RunStage: run the stage, such as running terraform, ansible, etc.
	RunStage(ctx context.Context, config OrchInstallerConfig, prevStageOutput RuntimeState) (RuntimeState, *OrchInstallerError)
	...
	PostStage(ctx context.Context, config OrchInstallerConfig, prevStageOutput RuntimeState, prevStageError *OrchInstallerError) (RuntimeState, *OrchInstallerError)
}
