...
{{- end }}
    ...
    {{- if and .Values.argo.o11y .Values.argo.o11y.edgeNode .Values.argo.o11y.edgeNode.mimir .Values.argo.o11y.edgeNode.mimir.structuredConfig }}
      ...
      query_scheduler:
        ...
        grpc_client_config:
          ...
          grpc_client_keepalive:
            keepalive_time: {{ .Values.argo.o11y.edgeNode.mimir.structuredConfig.querySchedulerGrpcClientConfig.keepaliveTime | default "30s" }}
            keepalive_timeout: {{ .Values.argo.o11y.edgeNode.mimir.structuredConfig.querySchedulerGrpcClientConfig.keepaliveTimeout | default "10s" }}
            keepalive_permit_without_stream: {{ .Values.argo.o11y.edgeNode.mimir.structuredConfig.querySchedulerGrpcClientConfig.keepalivePermitWithoutStream | default true }}
        {{- end }}
      {{- end }}
      ...
      frontend:
        ...
        grpc_client_config:
          ...
          # keepalive_permit_without_stream: Allows keepalive pings even when no active streams exist
          grpc_client_keepalive:
            keepalive_time: {{ .Values.argo.o11y.edgeNode.mimir.structuredConfig.frontendGrpcClientConfig.keepaliveTime | default "30s" }}
            keepalive_timeout: {{ .Values.argo.o11y.edgeNode.mimir.structuredConfig.frontendGrpcClientConfig.keepaliveTimeout | default "10s" }}
            keepalive_permit_without_stream: {{ .Values.argo.o11y.edgeNode.mimir.structuredConfig.frontendGrpcClientConfig.keepalivePermitWithoutStream | default true }}
        {{- end }}
      {{- end }}
  ...
  query_frontend:
    ...
    # BugFix #856: Added replica configuration for query_frontend to improve availability and load distribution
