...
|----------------------------------------|---------------------------------------------------------------|-------------------------------------------|
| **EIM + AO and/or CO**                 | `eks_desired_size: 1`<br>`eks_min_size: 1`<br>`eks_max_size: 5` | `eks_desired_size: 0`<br>`eks_min_size: 0`<br>`eks_max_size: 0` |
| **EIM + AO and/or CO + observability** | `eks_desired_size: 1`<br>`eks_min_size: 1`<br>`eks_max_size: 5` | `eks_desired_size: 1`<br>`eks_min_size: 1`<br>`eks_max_size: 1` |
