...
### Idea #1: Add a New Cluster Agent
...
### Idea #2: Extend the Existing Node Agent

Same approach as Idea #1, but without implementing a new database or agent.
...
### Idea #3: Use Cloud-Init Directly
...
A hybrid approach will be implemented that combines **Idea #2** and **Idea #3**.
