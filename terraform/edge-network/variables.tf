...
variable "dns_hosts" {
  ...
  default = [
    ...
    { hostname = "device-manager-node.onprem", ip = "192.168.99.30" },
    ...
    { hostname = "mps.cluster.onprem", ip = "192.168.99.30" },
    { hostname = "mps-wss.cluster.onprem", ip = "192.168.99.30" },
    { hostname = "rps.cluster.onprem", ip = "192.168.99.30" },
    { hostname = "rps-wss.cluster.onprem", ip = "192.168.99.30" },
    ...
    { hostname = "tinkerbell-haproxy.cluster.onprem", ip = "192.168.99.40" },
...
variable "dhcp_boot" {
  ...
  default     = "tag:efi-http,https://tinkerbell-haproxy.cluster.onprem/tink-stack/signed_ipxe.efi"
}
