...
# ----------------------------
CHART="oci://${RELEASE_SERVICE_URL}/edge-orch/common/charts/tenancy-api-mapping"
...
case "$ACTION" in
  ...
  uninstall)
    ...
    # Always return success so run-all.sh continues
    true
    ;;
